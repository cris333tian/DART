...
void main() {
  ...
  descuento y los rodillos un 15% de descuento. Los datos que se tienen por cada tipo de artículo son:
  la cantidad pedida y el precio unitario. Además, si se paga de contado todo tiene un descuento del 7%.
  ...
  */
  ...
  double precioBrochas, precioRodillos, costoTotal, descuentoBrocha, descuentoRodillo, descuento1,
  costoBrochas, costoRodillos, totalb, totalr;
  //ENTRADA

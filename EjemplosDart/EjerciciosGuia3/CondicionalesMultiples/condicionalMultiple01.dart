...
void main() {
  ...
  /*
  La empresa comercializadora Solva vende escobas, recogedores y aromatizantes, clasifica a sus clientes de acuerdo a la
  frecuencia de compras con las condiciones siguientes:
  ...
  */
  ...
  (cantRecogedores * precioRecogedor) + (cantAromatizantes * precioAromatizante);
  switch (categoria) {
    case 1:
